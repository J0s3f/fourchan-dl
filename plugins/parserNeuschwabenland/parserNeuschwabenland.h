#ifndef PARSERNEUSCHWABENLAND_H
#define PARSERNEUSCHWABENLAND_H
...
class ParserNeuschwabenland : public QObject, public ParserPluginInterface {
    Q_OBJECT
    Q_INTERFACES(ParserPluginInterface)
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "ParserNeuschwabenland" FILE "parserNeuschwabenland.json")
#endif

public:
    ParserNeuschwabenland();
    ...
    QObject* createInstance() {return new ParserNeuschwabenland();}
